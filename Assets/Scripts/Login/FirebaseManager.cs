...
public class FirebaseManager : MonoBehaviour
{
    ...
    public TMP_InputField floorField;
    ...
    public void SaveDataButton()
    {
        ...
        StartCoroutine(UpdateFloor(int.Parse(floorField.text)));
    ...
    private IEnumerator UpdateUsernameDatabase(string username)
    {
        ...
        {
            //Database usesrname is now updated
        }
    }

    private IEnumerator UpdateFloor(int floor)
    {
        var DBTask = DBreference.Child("users").Child(User.UserId).Child("floor").SetValueAsync(floor);
